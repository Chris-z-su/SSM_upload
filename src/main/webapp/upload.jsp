...
<head>
    ...
    <%--引入jQuery异步上传文件--%>
    <script src="/upload/js/jquery-1.6.2.js" type="application/javascript" charset="utf-8"></script>
    <script src="/upload/js/jquery.form.js" type="application/javascript" charset="utf-8"></script>
    ...
    <script type="text/javascript">
        function uploadPic() {
            ...
            if (flag) {
                ...
                // $('#imgForm').submit(function() { // 提交表单的id
